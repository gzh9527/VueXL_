<template>
  <div class="sina_page">
    <div class="sina_hasbg">
      ...
      <div class="newYearBanner">
        <img
          src="http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/addFamilynew.png"
          alt=""
        />
      </div>
      <div class="newYearBg">
        <div class="tips"><b>为谁加入</b>点击头像选择家人</div>
        <div class="sina_cont">
          <div class="who_cells">
            <div class="who_cell">
              <div
        ...
        <div class="tips"><b>让保障更加全面</b></div>
        <div class="sina_cont myAd">
          <my-ad id="weibo-insure-add-1" v-if="advertShow"></my-ad>
        </div>
      </div>
      <div class="join_btn">
        <button class="sina_btn NewYear radius" @click="addUserEvent">
          0元加入
        </button>
      </div>
      <!--      2020/8/13-->
...
.sina_page {
  ...
  .newYearBg {
    width: 100%;
    height: 1764px;
    background: url("http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/bgnew.png")
      no-repeat;
    background-size: cover;
    overflow: hidden;
    .tips {
      width: 496px;
      padding: 14px 0;
      background: linear-gradient(180deg, #ff7d57 0%, #fd4974 100%);
