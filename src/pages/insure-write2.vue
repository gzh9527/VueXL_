<template>
  <div class="sina_page">
    <div class="join_intro">
      ...
      <div class="swiper-container" ref="swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img
              v-if="channelFlag == 1"
              src="@/assets/images/join_banner2.png"
              alt
            />
            <img v-else src="@/assets/images/join_banner1.png" alt />
          </div>
          <div class="swiper-slide">
      ...
      <div
        class="imgTips"
        :style="switchImage ? 'margin-top:77%;' : 'margin-top:90%;'"
      >
        <img src="@/assets/images/renzheng.png" alt />
        <img src="@/assets/images/details.png" alt />
        <img src="@/assets/images/textPic.png" alt />
      ...
      <div class="sina_radius_bg join_form">
        <div class="add_form">
          <div class="switch">
            <img
              :src="switchImage ? imgCont[3] : imgCont[0]"
              @click="switchImg(1)"
              alt
            />
            <img
              :src="switchImage ? imgCont[1] : imgCont[2]"
              @click="switchImg(2)"
              alt
            />
          </div>
          <div class="add_title">
            {{ switchImage ? "本人信息" : "家人信息 (选填)" }}
          </div>
          <!-- 本人信息输入 -->
    ...
    <div class="sina_page_bot" @click="addJoin()" v-if="ishasbot">
      <div class="bot_btns">
        <div v-if="channelFlag == 1" class="bot_desc">
          <img src="@/assets/images/hb.png" alt />
          开通免密支付即送3元红包
        </div>
        <div v-else class="bot_desc">开通免密支付即送288积分</div>
...
export default {
  ...
  created() {
    console.log(typeof localStorage.getItem("channel"));
    if (this.$route.query.channel) {
      this.channel = this.$route.query.channel;
      localStorage.setItem("channel", this.channel);
    } else if (localStorage.getItem("channel") != "undefined" && localStorage.getItem("channel") != "null" ) {
  ...
  methods: {
    ...
    switchImg(e) {
      if (e == 1) {
        ...
        this.actionCount("switch_addFamily");
