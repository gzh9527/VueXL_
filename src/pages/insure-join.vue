<template>
  <div class="sina_page" :class="{ haspagebot: ishasbot }" ref="sinaPage">
    ...
    <div class="sina_hasbg maxbg" v-show="channelType && channelType == 'redChannel' && sinaActived == 'ActivedVer1'"
      style="
        width: 100%;
        height: 730px;
        background: url('http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/sinaBG3.png')no-repeat;
        background-size: 100%;"
    >
      <div class="sina_join_cont">
        <div class="join_btn" style="margin-top: 110px">
          <input
            type="tel"
            autocomplete="off"
            maxlength="11"
    ...
    <!-- 新增新浪微博抽奖对应活动 2021/1/12 -->
    <div class="sina_hasbg maxbg" v-show="channelType && sinaActived == 'ActivedVer2'"
      style="
        width: 100%;
        height: 730px;
        background: url('http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/sinaBG30.png')no-repeat;
        background-size: 100%;">
      <div class="sina_join_cont">
        <div class="join_btn" style="margin-top: 110px">
          <input
    ...
    <transition name="translate-bottom">
      <div class="sina_join_bot" v-if="ishasbot">
        <button class="sina_btn primary radius max" v-if="sinaActived=='normalActived'" @click="addPlan()">
          {{
        ...
        <button v-else class="sina_btn primary radius max" @click="addPlan()">
                立即领取
        </button>
        <div
