<template>
  ...
  <div class="sina_page" :class="{ haspagebot: ishasbot }" ref="sinaPage">
    ...
    <div
      ...
      style="
        width: 100%;
        background: url('http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/join1.png')
          no-repeat;
    ...
    <div
      ...
      style="
        width: 100%;
        background: url('http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/join1_2.png')
          no-repeat;
        background-size: cover;
      "
    >
  ...
  data() {
    return {
      ...
      imgsList: [
        {
          url:
            "http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/join2.png",
        },
        {
          url:
            "http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/join3.png",
        },
        {
          url:
            "http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/join4.png",
        },
      ],
      adInfo: {
        img_url:
