<template>
  <div class="sina_page">
    <img src="http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/addFriends.png">
    <div class="top_txt" @click="showDesc">活动规则</div>
    <div class="valent_from">
      <div class="valent_bg">
        <div class="input_cells" style="margin-top:20px">
        ...
        <div class="rule_btn" @click="showDesc">已有50万人领取新冠保障</div>
      </div>
    </div>
    <div class="img_cont">
      <div class="title">好友可获得的互助权益</div>
      <img src="http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/addFriends2.png">
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      showDesc() {
        this.$sinaAlert({
          onlyHasTitle: false,
          desc: `<div class="alert_ul"><p class="alert_li" style="font-size:13px;">填写必填信息后发送给好友，好友激活权益后本人可获得1元红包，好友可获得3元红包。</p>
                <p class="alert_li" style="font-size:13px;padding-bottom:30px;"> 邀请多名好友可重复领取红包。</p></div>`,
    ...
    .valent_from {
      ...
      .valent_bg {
        ...
        .max{
          margin-top: 12px;
          position: relative;
          background: url("http://sinahuzhu.oss-cn-beijing.aliyuncs.com/images/sina_publicity_temp/button%402x.png");
